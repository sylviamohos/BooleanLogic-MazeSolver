...
public class MazeSolver {
    ...
    //private static final float MINIMUM_FORWARD_DISTANCE = 20.0F;
   // private static final float MINIMUM_LEFT_DISTANCE = 22.0F;
    ...
    public void move() {
        ...
        //if the robot senses a wall in the front (distanceSensors.x)
        //&& the robot senses a wall on its left (distanceSensors.y)
        //turn right
        //if a robot senses a wall only on it's left (moveForward);
        //moveForward();
        //if there is no close wall in from of me, go forward
        // if (distanceSen.x > 20) { moveForward();
        // } else if(distanceSen.y > 20) { turn(Direction.LEFT);
        //y- 30, x - 10
        //} else { turn(Direction.RIGHT);
        if (distanceSensors.x > 15) {
            moveForward();
        } else if (distanceSensors.y > 30) {
            turn(Direction.LEFT);
        } else turn(Direction.RIGHT);
    }
